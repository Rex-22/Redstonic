...
public class RedstonicItems {
    ...
    public static void init() {
        ...
        // if(ConfigHandler.redstonicContainer)GameRegistry.registerItem(RedContainer,
        // RedContainer.getUnlocalizedName());
        ...
        if (ConfigHandler.redstonicDrill) {
            ...
            if (ConfigHandler.FortuitousHead)
        ...
        if (ConfigHandler.redstonicDrill) {
            ...
            if (ConfigHandler.EnergeticBody)
        ...
        if (ConfigHandler.RedstoneInfusedStick)
        ...
        if (ConfigHandler.EnergizedBattery)
        ...
        if (ConfigHandler.InfiniteBattery)
