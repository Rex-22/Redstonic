...
public class SwordUtil {
    ...
    public static int getBladeNumber(ItemStack blade) {
        Item[] heads = new Item[] { RedstonicItems.IronBlade, RedstonicItems.DiamondBlade, RedstonicItems.ElectrumBlade,
            RedstonicItems.EnderiumBlade, RedstonicItems.EnergizedBlade, RedstonicItems.VibrantBlade };
    ...
    public static int getHandleNumber(ItemStack handle) {
        Item[] heads = new Item[] { RedstonicItems.WoodHandle, RedstonicItems.IronHandle, RedstonicItems.ElectrumHandle,
            RedstonicItems.EnderiumHandle, RedstonicItems.EnergizedHandle, RedstonicItems.VibrantHandle };
        for (int i = 0; i < heads.length; i++) {
    ...
    public static int getAugNumber(ItemStack stack) {
        ...
        Item[] augs = new Item[] { RedstonicItems.BlazerSwordAugment, RedstonicItems.FortuitousSwordAugment,
            RedstonicItems.BerserkSwordAugment, RedstonicItems.BerserkIISwordAugment };
    ...
    public static String getAugName(int i) {
        ...
        switch (i) {
            case 1:
                ...
                break;
            case 2:
                name = "Fortuitous Augment";
                break;
            case 3:
                name = "Berserk +2 Damage";
                break;
            case 4:
                name = "Berserk II +3 Damage";
                break;
            default:
