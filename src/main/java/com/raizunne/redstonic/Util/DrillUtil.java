...
public class DrillUtil {
    ...
    public static ItemStack getDrillBattery(int i, ItemStack drill) {
        ...
        ItemStack temp = null;
        int battery = drill.stackTagCompound.getInteger("battery");
        switch (i) {
            case 0:
                temp = hardened;
                break;
            ...
            case 2:
                ...
                break;
            case 3:
                temp = Util.toStack(RedstonicItems.basicBattery);
                break;
            case 4:
                temp = Util.toStack(RedstonicItems.energizedBattery);
                break;
            case 5:
                temp = Util.toStack(RedstonicItems.greatBattery);
                break;
            case -1:
                temp = creative;
                return temp;
            case -2:
                temp = Util.toStack(RedstonicItems.infiniteBattery);
                return temp;
        }
        if (temp == null) {
            return null;
        ...
        int energyerino = drill.stackTagCompound.hasKey("Energy") ? drill.stackTagCompound.getInteger("Energy")
            : drill.stackTagCompound.getInteger("energy");
    ...
    public static ItemStack getAugments(int i, int h) {
        switch (i) {
            ...
            case 6:
                return new ItemStack(RedstonicItems.SpeedIIAugment);
            default:
                return null;
        }
    }
    ...
    public static String getAugName(int i) {
        ...
        switch (i) {
            case 1:
                name = "x1.5 Dig Speed Multiplier";
                break;
            case 2:
                name = "x2.5 Energy Multiplier";
                break;
            case 3:
                name = "Hotswap";
                break;
            case 4:
                ...
                break;
            case 5:
                name = "Magnerization Augment";
                break;
            case 6:
                name = "x2.0 Dig Speed Multiplier";
                break;
            default:
                name = "Unknown";
                break;
    ...
    public static int getHeadNumber(ItemStack stack) {
        ItemStack[] heads = new ItemStack[] { Util.toStack(RedstonicItems.IronHead),
            Util.toStack(RedstonicItems.GoldHead), Util.toStack(RedstonicItems.DiamondHead),
            Util.toStack(RedstonicItems.HeavyHead), Util.toStack(RedstonicItems.FortuitousHead),
            Util.toStack(RedstonicItems.SilkyHead), Util.toStack(RedstonicItems.BlazerHead),
            Util.toStack(RedstonicItems.EndHead) };
    ...
    public static int getBodyNumber(ItemStack stack) {
        ItemStack[] bodies = new ItemStack[] { Util.toStack(RedstonicItems.IronBody),
            Util.toStack(RedstonicItems.ElectrumBody), Util.toStack(RedstonicItems.EnderiumBody),
            Util.toStack(RedstonicItems.UltimateBody), Util.toStack(RedstonicItems.EnergeticBody),
            Util.toStack(RedstonicItems.VibrantBody) };
    ...
    public static int getBatteryNumber(ItemStack stack) {
        ...
        ItemStack resonant = GameRegistry.findItemStack("ThermalExpansion", "capacitorResonant", 1);
        ItemStack creative = GameRegistry.findItemStack("ThermalExpansion", "capacitorCreative", 1);
        Item[] batteries = new Item[] { RedstonicItems.basicBattery, RedstonicItems.energizedBattery,
            RedstonicItems.greatBattery };
        ItemStack[] capacitor = new ItemStack[] { hardened, reinforced, resonant };
        if (Loader.isModLoaded("ThermalExpansion")) {
            if (stack.isItemEqual(creative)) {
                return -1;
            } else for (int i = 0; i < capacitor.length; i++) {
    ...
    public static int getAugNumber(ItemStack item) {
        ...
        ItemStack[] augments = new ItemStack[] { Util.toStack(RedstonicItems.SpeedAugment),
            Util.toStack(RedstonicItems.EnergyAugment), Util.toStack(RedstonicItems.HotswapAugment),
            Util.toStack(RedstonicItems.BlockAugment), Util.toStack(RedstonicItems.MagnetAugment),
            Util.toStack(RedstonicItems.SpeedIIAugment) };
    ...
    public static int getEnergyAmount(ItemStack i, ItemStack drill) {
        ...
        int tier3 = 3200000;
        float multiplier = 1;
        if (drill.stackTagCompound.getInteger("body") == 3) {
            multiplier = 3;
        }
        if (Loader.isModLoaded("ThermalExpansion")) {
    ...
    public static ItemStack applyAug(int aug, ItemStack drill, int hotswapHead) {
        switch (aug) {
            case 1:
                drill.stackTagCompound.setFloat("speedMulti", 1.5F);
                return drill;
            case 2:
                drill.stackTagCompound.setFloat("energyMulti", 2.5F);
                return drill;
            case 3:
                drill.stackTagCompound.setInteger("hotswapHead", hotswapHead);
                return drill;
            case 4:
                return drill;
            case 5:
