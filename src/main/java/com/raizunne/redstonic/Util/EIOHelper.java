...
public class EIOHelper {
    ...
    public static void addAlloySmelterRecipe(String name, int energy, ItemStack slot1, ItemStack slot2, ItemStack slot3,
        ItemStack output) {
        ...
        sending.append("<recipeGroup name=\"Redstonic\">");
        {
            sending.append("<recipe name=\"" + name + "\" energyCost=\"" + energy + "\">");
            {
                ...
                {
                    if (slot1 != null) {
                        String[] item1 = Item.itemRegistry.getNameForObject(slot1.getItem())
                            .split(":");
                        sending.append(
                            "<itemStack modID=\"" + item1[0]
                                + "\" itemName=\""
                                + item1[1]
                                + "\" itemMeta=\""
                                + slot1.getItemDamage()
                    ...
                    if (slot2 != null) {
                        String[] item2 = Item.itemRegistry.getNameForObject(slot2.getItem())
                            .split(":");
                        sending.append(
                            "<itemStack modID=\"" + item2[0]
                                + "\" itemName=\""
                                + item2[1]
                                + "\" itemMeta=\""
                                + slot2.getItemDamage()
                    ...
                    if (slot3 != null) {
                        String[] item3 = Item.itemRegistry.getNameForObject(slot3.getItem())
                            .split(":");
                        sending.append(
                            "<itemStack modID=\"" + item3[0]
                                + "\" itemName=\""
                                + item3[1]
                                + "\" itemMeta=\""
                                + slot3.getItemDamage()
                ...
                {
                    String[] outputerino = Item.itemRegistry.getNameForObject(output.getItem())
                        .split(":");
                    sending.append(
                        "<itemStack modID=\"" + outputerino[0]
                            + "\" itemName=\""
                            + outputerino[1]
                            + "\" itemMeta=\""
