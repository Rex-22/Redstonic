...
public class Util {
    ...
    public static final String ItemShiftInfo = Lang.translate("drill.hold") + " "
    ...
    public static final String ItemCtrlInfo = Lang.translate("drill.hold") + " "
        + EnumChatFormatting.ITALIC
        + EnumChatFormatting.YELLOW
        + Lang.translate("util.Control")
        + EnumChatFormatting.RESET
        + EnumChatFormatting.GRAY
        + " "
        + Lang.translate("drill.formoreauginfo");
    public static final String ItemAltInfo = Lang.translate("drill.hold") + " "
        + EnumChatFormatting.ITALIC
        + EnumChatFormatting.GREEN
        + Lang.translate("util.Alt")
        + EnumChatFormatting.RESET
        + EnumChatFormatting.GRAY
        + " "
        + Lang.translate("drill.formorekillinfo");
    ...
    public static String[] getMaterialInfo(int i) {
        switch (i) {
            case 0:
                return new String[] { "Crafting Material",
                    "Requires " + EnumChatFormatting.RED
                        + "64000"
                        + EnumChatFormatting.GRAY
                        + " Destabilized Redstone to fill.",
                    "or 72 Redstone Blocks" };
            case 1:
                return new String[] { "Crafting Material",
                    "Contains " + EnumChatFormatting.RED
                        + "64000"
                        + EnumChatFormatting.GRAY
    ...
    public static String[] getBodyInfo(int i) {
        switch (i) {
            case 1:
                return new String[] { "Max Augments: 1" };
            case 2:
                return new String[] { "Max Augments: 2" };
            case 3:
                return new String[] { "Max Augments: 3" };
            case 4:
                return new String[] { "Max Augments: 0", "x3 Energy Storage Multiplier" };
            case 5:
                return new String[] { "Max Augments: 2" };
            case 6:
                return new String[] { "Max Augments: 3" };
    ...
    public static String[] getAugmentInfo(int i, ItemStack stack) {
        ...
        switch (i) {
            ...
            case 2:
                return new String[] { "Quick exchange of Drill Heads", "1500 RF per change.",
                    EnumChatFormatting.YELLOW + "Head: "
                        + EnumChatFormatting.RED
                        + hotswapHead
                        + EnumChatFormatting.GRAY
                        + " Head",
            ...
            case 4:
                return new String[] { "Attract items to your being." };
            default:
                return null;
        }
    }
    ...
    public static String[] getSwordAugmentInfo(int i, ItemStack stack) {
        switch (i) {
            case 1:
                return new String[] { "Fire Enchantment" };
            case 2:
                return new String[] { "Looting Enchantment" };
            case 3:
                return new String[] { "+2 Heart Damage" };
            case 4:
                return new String[] { "+3 Heart Damage", "Can stack with other levels." };
            default:
                return null;
        }
    }
    ...
    public static boolean getCurrentItem(Item stack) {
        return Minecraft.getMinecraft().thePlayer.inventory.getCurrentItem() != null
    ...
    public static ItemStack oreStack(String stack, int size, int meta) {
        ItemStack stackerino = (ItemStack) OreDictionary.getOres(stack)
            .toArray()[0];
