...
public class RedstonicDrill extends ItemPickaxe implements IEnergyContainerItem {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean yowtf) {
        if (stack.stackTagCompound == null) {
            ...
            if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) {
                ...
                list.add(
                    Lang.translate("drill.hold") + " "
                        + EnumChatFormatting.RED
                        + Lang.translate("util.Shift")
                        + EnumChatFormatting.RESET
                        + " "
                        + EnumChatFormatting.GRAY
                        + Lang.translate("drill.formoreinfo"));
            }
        } else {
            ...
            list.add(
                EnumChatFormatting.GREEN + "Energy: "
                    + EnumChatFormatting.GRAY
                    + (creative
                        ? EnumChatFormatting.OBFUSCATED + "Creative"
                            + EnumChatFormatting.RESET
                            + EnumChatFormatting.GRAY
                        : Lang.addComas(tag.getInteger("energy")))
                    + "/"
                    + (creative ? "Creative" : Lang.addComas(tag.getInteger("maxEnergy")))
                    + " RF");
            ...
            if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) {
                list.add(
                    EnumChatFormatting.GRAY + Lang.translate("drill.head")
                        + ": "
                        + EnumChatFormatting.DARK_GRAY
                        + head);
                list.add(
                    EnumChatFormatting.GRAY + Lang.translate("drill.body")
                        + ": "
                        + EnumChatFormatting.DARK_GRAY
                        + body);
                list.add(
                    EnumChatFormatting.GRAY + Lang.translate("drill.battery")
                        + ": "
                        + EnumChatFormatting.DARK_GRAY
                        + (creative ? "Creative" : DrillUtil.getBatteryName(tag.getInteger("battery"))));
                list.add(
                    EnumChatFormatting.GRAY + Lang.translate("drill.digspeed")
                        + ": "
                        + EnumChatFormatting.DARK_GRAY
                        + (tag.getInteger("head") == 7 ? EnumChatFormatting.OBFUSCATED + "100F" : speed));
                list.add(
                    EnumChatFormatting.GRAY + Lang
                        .translate("drill.energyusage") + ": " + EnumChatFormatting.YELLOW + calcEnergy(stack) + " RF");
                list.add(
                    EnumChatFormatting.GRAY + "Blocks Destroyed: "
                        + EnumChatFormatting.RED
                        + Lang.addComas(tag.getInteger("blocks")));
                ...
                if (tag.getInteger("aug1") != 0) {
                    list.add(
                        EnumChatFormatting.YELLOW + Lang.translate("drill.augment")
                            + ": "
                            + EnumChatFormatting.DARK_GRAY
                            + DrillUtil.getAugName(tag.getInteger("aug1")));
                }
                if (tag.getInteger("aug2") != 0) {
                    list.add(
                        EnumChatFormatting.YELLOW + Lang.translate("drill.augment")
                            + ": "
                            + EnumChatFormatting.DARK_GRAY
                            + DrillUtil.getAugName(tag.getInteger("aug2")));
                }
                if (tag.getInteger("aug3") != 0) {
                    list.add(
                        EnumChatFormatting.YELLOW + Lang.translate("drill.augment")
                            + ": "
                            + EnumChatFormatting.DARK_GRAY
                            + DrillUtil.getAugName(tag.getInteger("aug3")));
                }
                if (hasAugment(3, stack)) {
                    list.add(
                        EnumChatFormatting.RED + "Hotswap: "
                            + EnumChatFormatting.GRAY
                            + DrillUtil.getDrillHeadName(tag.getInteger("hotswapHead"))
                            + " Drill Head");
                }
            } else {
                list.add(Util.ItemShiftInfo);
                if (!hasNOAugment(stack)) {
        ...
        if (!player.worldObj.isRemote) {
            player.addChatComponentMessage(
                new ChatComponentText(
                    EnumChatFormatting.RED + "Redstonic Drill: "
                        + EnumChatFormatting.WHITE
                        + "You've reached "
                        + i
                        + " mined blocks! Way to go!"));
    ...
    public void onUpdate(ItemStack stack, World world, Entity entity, int p_77663_4_, boolean p_77663_5_) {
        ...
        if (nbt == null) {
            ...
            if (hasAugment(5, stack) && !nbt.getBoolean("aug" + getAugNumber(5, stack) + "Deactivated")) {
                AxisAlignedBB abb = AxisAlignedBB.getBoundingBox(
                    player.posX - 4,
                    player.posY - 5,
                    player.posZ - 4,
                    player.posX + 4,
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
        ...
        if (!player.isSneaking()) {
            if (hasAugment(4, stack)) {
                placeBlock(
                    Block.getBlockById(nbt.getInteger("placeBlock")),
                    nbt.getInteger("placeBlockMeta"),
                    world,
                    player);
            } else {
        ...
        if (player.isSneaking()) {
            ...
            if (pos != null && pos.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                if (Block.getBlockById(nbt.getInteger("placeBlock"))
                    != world.getBlock(pos.blockX, pos.blockX, pos.blockZ) && hasAugment(4, stack)) {
    ...
    public void placeTorch(World world, EntityPlayer player) {
        ...
        if (Loader.isModLoaded("TConstruct")) {
            ...
            if (player.inventory.hasItemStack(new ItemStack(Blocks.torch))) {
                ...
                .hasItemStack(GameRegistry.findItemStack("TConstruct", "decoration.stonetorch", 1))) {
        ...
        if (player.inventory.hasItemStack(new ItemStack(block))) {
            if (pos != null && pos.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                int posY = pos.blockY;
                int posZ = pos.blockZ;
                if (world.getBlock(posX, posY, posZ) != torchVanilla && world.getBlock(posX, posY, posZ) != torchTCon
                    && pos.sideHit != 0) {
                    switch (pos.sideHit) {
                        case 1:
                            if (world.getBlock(posX, posY + 1, posZ) != torchVanilla
                                && world.getBlock(posX, posY + 1, posZ) != torchTCon
                            ...
                            break;
                        case 2:
                            if (world.getBlock(posX, posY, posZ - 1) != torchVanilla
                                && world.getBlock(posX, posY, posZ - 1) != torchTCon
                                && world.getBlock(posX, posY, posZ - 1) == Blocks.air) {
                                if (!world.isRemote) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            if (world.getBlock(posX - 1, posY, posZ) != torchVanilla
                                && world.getBlock(posX - 1, posY, posZ) != torchTCon
                                && world.getBlock(posX - 1, posY, posZ) == Blocks.air) {
                                if (!world.isRemote) {
    ...
    public static int getAugNumber(int i, ItemStack drill) {
        int[] augments = { drill.stackTagCompound.getInteger("aug1"), drill.stackTagCompound.getInteger("aug2"),
            drill.stackTagCompound.getInteger("aug3") };
    ...
    public boolean onBlockDestroyed(ItemStack stack, World world, Block block, int x, int y, int z,
        ...
        if (stack.stackTagCompound.getInteger("head") != 3) {
            stack.stackTagCompound.setInteger("blocks", stack.stackTagCompound.getInteger("blocks") + 1);
        }
    ...
    public static float getBaseDigSpeed(ItemStack stack, Block block) {
        ...
        switch (head) {
            case 0:
                return (float) ConfigHandler.ironDrillSpeed * multiplier;
            case 1:
                return (float) ConfigHandler.goldDrillSpeed * multiplier;
            case 2:
                return (float) ConfigHandler.diamondDrillSpeed * multiplier;
            case 3:
                return (float) ConfigHandler.heavyDrillSpeed * multiplier;
            case 4:
                return (float) ConfigHandler.fortuitousDrillSpeed * multiplier;
            case 5:
                return (float) ConfigHandler.silkyDrillSpeed * multiplier;
            case 6:
                return (float) ConfigHandler.blazerDrillSpeed * multiplier;
            case 7:
                return 200F * multiplier;
            default:
                return 1F;
        }
    }
                    ...
                    for (int r = 0; r <= 2; r++) {
                        if (checkHeavy(world, block, ogx, ogy, ogz, x + i, y, z + r)) {
                            stack.stackTagCompound
                                .setInteger("blocks", stack.stackTagCompound.getInteger("blocks") + 1);
    ...
    public IIcon getIcon(ItemStack stack, int pass) {
        ...
        if (nbt != null) {
            ...
            if (pass == 2) {
                return !nbt.getBoolean("aug1Deactivated") ? augments[nbt.getInteger("aug1")]
                    : augmentsALT[nbt.getInteger("aug1")];
            }
            if (pass == 3) {
                return !nbt.getBoolean("aug2Deactivated") ? augments[nbt.getInteger("aug2")]
                    : augmentsALT[nbt.getInteger("aug2")];
            }
            if (pass == 4) {
                return !nbt.getBoolean("aug3Deactivated") ? augments[nbt.getInteger("aug3")]
                    : augmentsALT[nbt.getInteger("aug3")];
            }
            if (pass == 5) {
                if (nbt.getBoolean("mode")) {
                    return extras[0];
    ...
    public boolean checkHeavy(World world, Block block, int x, int y, int z, int bx, int by, int bz) {
        ...
        if ((world.getTileEntity(bx, by, bz) == null || block == Blocks.redstone_ore) && world.getBlock(x, y, z)
            .getBlockHardness(world, x, y, z) <= block.getBlockHardness(world, bx, by, bz) + 5F
            && !world.getBlock(bx, by, bz)
                .isFlammable(world, bx, by, bz, null)
            && !(world.getBlock(bx, by, bz) instanceof BlockCrops && world.getBlock(bx, by, bz) != Blocks.bedrock)
    ...
    public boolean checkEnergy(ItemStack stack, int i) {
        if (stack.stackTagCompound.getInteger("maxEnergy") == -1 || stack.stackTagCompound.getInteger("maxEnergy") == -2
            || stack.stackTagCompound.getInteger("maxEnergy") == -5) {
            return true;
    ...
    public int calcEnergy(ItemStack stack) {
        ...
        switch (head) {
            ...
            case 3:
                return (int) (1800 * multiplier);
            case 4:
                return (int) (1000 * multiplier);
            case 5:
                return (int) (700 * multiplier);
            case 6:
                return (int) (100 * multiplier);
            case 7:
                return (int) (3500 * multiplier);
            default:
                return 0;
        }
    }
