...
public class ButtonDirectional extends GuiButton {
    ...
    public static enum Type {
        ...
        LEFT_CURVED(18, 10, 0, 51, 19, 51),
        RIGHT_CURVED(18, 10, 0, 40, 19, 40),
        LEFT_STRAIGHT(13, 9, 38, 40, 52, 40),
        RIGHT_STRAIGHT(13, 9, 38, 50, 52, 50),
        UP_STRAIGHT(9, 13, 66, 40, 76, 40),
        DOWN_STRAIGHT(9, 13, 86, 40, 96, 40);
    ...
    public void drawButton(Minecraft mc, int p_146112_2_, int p_146112_3_) {
        int xTex;
        int yTex;
        this.field_146123_n = p_146112_2_ >= this.x && p_146112_3_ >= this.y
            && p_146112_2_ < this.x + this.width
