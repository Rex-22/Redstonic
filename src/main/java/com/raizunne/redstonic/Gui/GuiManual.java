...
import com.raizunne.redstonic.Tags;
...
public class GuiManual extends GuiScreen {
    ...
    public void drawScreen(int x, int y, float f) {
        ...
        if (page == "index") {
            if (!ClientProxy.version.equals(Tags.VERSION)) {
                drawStatsText("Redstonic is outadated!", "", 0x000000, 0x404040, 140, 140);
            }
        } else if (page == "Heads") {
            drawStatsText("Iron Head", "Medium Speed", 0x404040, 0x009933, 160, 15);
            drawStatsText("Gold Head", "Very Fast Speed", 0x404040, 0x009933, 160, 35);
            drawStatsText("Diamond Head", "Fast Speed", 0x404040, 0x009933, 160, 55);
            drawStatsText("Fortuitous Head", "Slow - Fortune Mining", 0x404040, 0x009933, 160, 75);
            drawStatsText("Heavy Head", "Medium - 3x3 Mining", 0x404040, 0x009933, 160, 95);
            drawStatsText("Silky Head", "Slow - Silk Touch I", 0x404040, 0x009933, 160, 115);
            drawStatsText("End Drill Head", "Instant Speed", 0x404040, 0x009933, 160, 135);
            drawItem(RedstonicItems.IronHead, 140, 15, x, y);
            drawItem(RedstonicItems.GoldHead, 140, 35, x, y);
            drawItem(RedstonicItems.DiamondHead, 140, 55, x, y);
            drawItem(RedstonicItems.FortuitousHead, 140, 75, x, y);
            drawItem(RedstonicItems.HeavyHead, 140, 95, x, y);
            drawItem(RedstonicItems.SilkyHead, 140, 115, x, y);
            drawItem(RedstonicItems.EndHead, 140, 135, x, y);
        } else if (page == "Bodies") {
            drawStatsText("Iron Body", "1 Augment Slot", 0x404040, 0x009933, 160, 20);
            drawStatsText("Electrum Body", "2 Augment Slot", 0x404040, 0x009933, 160, 40);
            drawStatsText("Enderium Body", "3 Augment Slot", 0x404040, 0x009933, 160, 60);
            drawStatsText("Energetic Body", "2 Augment Slot", 0x404040, 0x009933, 160, 80);
            drawStatsText("Vibrant Body", "3 Augment Slot", 0x404040, 0x009933, 160, 100);
            drawStatsText("Ultimate Body", "0 Augment Slot", 0x404040, 0x009933, 160, 120);
            drawItem(RedstonicItems.IronBody, 140, 20, x, y);
            drawItem(RedstonicItems.ElectrumBody, 140, 40, x, y);
            drawItem(RedstonicItems.EnderiumBody, 140, 60, x, y);
            drawItem(RedstonicItems.EnergeticBody, 140, 80, x, y);
            drawItem(RedstonicItems.VibrantBody, 140, 100, x, y);
            drawItem(RedstonicItems.UltimateBody, 140, 120, x, y);
        } else if (page == "Energy") {
            ...
            drawText(
                "Redstonic is made completely by Raizunne, but he is also limited in his capabilities!. If you wish to contribute with Redstonic, Raizunne (Me), is looking for some work done for Redstonic!",
                135,
                135,
                20);
            ...
            if (subPage == 1) {
                drawStatsText("Speed Augment I", "x1.5 Dig Speed Mutli", 0x404040, 0x009933, 160, 20);
                drawStatsText("Energy Augment I", "x1.5 Max Energy Multi", 0x404040, 0x009933, 160, 40);
                drawStatsText("Hotswap Augment", "See next page", 0x404040, 0x009933, 160, 60);
                drawStatsText("Block Placer Augment", "Place blocks", 0x404040, 0x009933, 160, 80);
                drawStatsText("Magnetization Augment", "Attacts item entities.", 0x404040, 0x009933, 160, 100);
                drawItem(RedstonicItems.SpeedAugment, 140, 20, x, y);
                drawItem(RedstonicItems.EnergyAugment, 140, 40, x, y);
                drawItem(RedstonicItems.HotswapAugment, 140, 60, x, y);
                drawItem(RedstonicItems.BlockAugment, 140, 80, x, y);
                drawItem(RedstonicItems.MagnetAugment, 140, 100, x, y);
            } else if (subPage == 2) {
                ...
                drawCrafting(
                    null,
                    RedstonicItems.IronHead,
                    null,
                    null,
                    RedstonicItems.HotswapAugment,
                    null,
                    null,
                    null,
                    null,
        ...
        } else if (page == "Driller") {} else if (page == "Blades") {
            drawStatsText("Iron Blade", "4 Heart damage", 0x404040, 0x009933, 160, 15);
            drawStatsText("Diamond Blade", "6 Heart damage", 0x404040, 0x009933, 160, 35);
            drawStatsText("Electrum Blade", "9 Heart damage", 0x404040, 0x009933, 160, 55);
            drawStatsText("Enderium Blade", "11 Heart damage", 0x404040, 0x009933, 160, 75);
            drawStatsText("Energetic Blade", "9 Heart damage", 0x404040, 0x009933, 160, 95);
            drawStatsText("Vibrant Blade", "11 Heart damage", 0x404040, 0x009933, 160, 115);
            drawItem(RedstonicItems.IronBlade, 140, 15, x, y);
            drawItem(RedstonicItems.DiamondBlade, 140, 35, x, y);
            drawItem(RedstonicItems.ElectrumBlade, 140, 55, x, y);
            drawItem(RedstonicItems.EnderiumBlade, 140, 75, x, y);
            drawItem(RedstonicItems.EnergizedBlade, 140, 95, x, y);
            drawItem(RedstonicItems.VibrantBlade, 140, 115, x, y);
        } else if (page == "Handles") {
            drawStatsText("Wood Handle", "0 Augment Slots", 0x404040, 0x009933, 160, 15);
            drawStatsText("Iron Handle", "1 Augment Slot", 0x404040, 0x009933, 160, 35);
            drawStatsText("Electrum Handle", "2 Augment Slots", 0x404040, 0x009933, 160, 55);
            drawStatsText("Enderium Handle", "3 Augment Slots", 0x404040, 0x009933, 160, 75);
            drawStatsText("Energetic Handle", "2 Augment Slots", 0x404040, 0x009933, 160, 95);
            drawStatsText("Vibrant Handle", "3 Augment Slots", 0x404040, 0x009933, 160, 115);
            drawItem(RedstonicItems.WoodHandle, 140, 15, x, y);
            drawItem(RedstonicItems.IronHandle, 140, 35, x, y);
            drawItem(RedstonicItems.ElectrumHandle, 140, 55, x, y);
            drawItem(RedstonicItems.EnderiumHandle, 140, 75, x, y);
            drawItem(RedstonicItems.EnergizedHandle, 140, 95, x, y);
            drawItem(RedstonicItems.VibrantHandle, 140, 115, x, y);
        } else if (page == "Sword Augments") {
            drawStatsText("Berserk II Augment", "+2 Heart Damage", 0x404040, 0x009933, 155, 20);
            drawStatsText("Berserk II Augment", "+3 Heart Damage", 0x404040, 0x009933, 155, 40);
            drawStatsText("Blazer Augment", "Fire Aspect II", 0x404040, 0x009933, 155, 60);
            drawStatsText("Fortuitous Augment", "Looting", 0x404040, 0x009933, 155, 80);
            drawStatsText("Magnetization Augment", "Attacts item entities.", 0x404040, 0x009933, 155, 100);
            drawItem(RedstonicItems.SpeedAugment, 135, 20, x, y);
            drawItem(RedstonicItems.EnergyAugment, 135, 40, x, y);
            drawItem(RedstonicItems.HotswapAugment, 135, 60, x, y);
            drawItem(RedstonicItems.BlockAugment, 135, 80, x, y);
            drawItem(RedstonicItems.MagnetAugment, 135, 100, x, y);
        }
    ...
    public void initGui() {
        ...
        ButtonDirectional right = new ButtonDirectional(
            -2,
            posX + 232,
            posY + 171,
            ButtonDirectional.Type.RIGHT_CURVED);
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        switch (button.id) {
            case -3:
                if (page == "drills" || page == "extras" || page == "Contribute!") {
                    page = "index";
                    maxPages = 1;
                    subPage = 1;
                } else {
            ...
            case 10000:
                try {
                    Desktop.getDesktop()
                        .browse(
                            URI.create(
                                "http://raizunne.github.io/Mods/Redstonic/Changelog.html#" + ClientProxy.version));
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
            ...
            case 900:
                try {
                    Desktop.getDesktop()
                        .browse(URI.create("https://github.com/Raizunne/Redstonic/issues"));
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
            case 901:
                try {
                    Desktop.getDesktop()
                        .browse(URI.create("http://raizunne.github.io"));
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
            case 902:
                try {
                    Desktop.getDesktop()
                        .browse(URI.create("https://www.patreon.com/raizunne"));
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
    ...
    public void drawCrafting(Object i1, Object i2, Object i3, Object i4, Object i5, Object i6, Object i7, Object i8,
        Object i9, Object pro, int yPos, int xPos, int mousex, int mousey) {
        ...
        ItemStack slot1 = null, slot2 = null, slot3 = null, slot4 = null, slot5 = null, slot6 = null, slot7 = null,
            slot8 = null, slot9 = null, product = null;
        ...
        if (slot1 != null) {
            if (mousex > xPosCrafting + 2 && mousex < xPosCrafting + 16
                && mousey > yPosCrafting + 2
                && mousey < yPosCrafting + 16) {
                renderToolTip(slot1, mousex, mousey);
            }
        }
        if (slot2 != null) {
            if (mousex > xPosCrafting + 21 && mousex < xPosCrafting + 35
                && mousey > yPosCrafting + 2
                && mousey < yPosCrafting + 16) {
        ...
        if (slot3 != null) {
            if (mousex > xPosCrafting + 40 && mousex < xPosCrafting + 54
                && mousey > yPosCrafting + 2
                && mousey < yPosCrafting + 16) {
        ...
        if (slot4 != null) {
            if (mousex > xPosCrafting + 2 && mousex < xPosCrafting + 16
                && mousey > yPosCrafting + 21
                && mousey < yPosCrafting + 35) {
        ...
        if (slot7 != null) {
            if (mousex > xPosCrafting + 2 && mousex < xPosCrafting + 16
                && mousey > yPosCrafting + 40
                && mousey < yPosCrafting + 54) {
        ...
        if (mousex > xPosCrafting + 58 && mousex < xPosCrafting + 72
            && mousey > yPosCrafting + 26
            && mousey < yPosCrafting + 42) {
        ...
        RenderHelper.disableStandardItemLighting();
        GL11.glEnable(GL11.GL_DEPTH_TEST);
        if (mousex > xPosCrafting + 60 && mousex < xPosCrafting + 74
            && mousey > yPosCrafting + 9
            && mousey < yPosCrafting + 23) {
