...
public class TEDrillModifier extends TileEntity implements IInventory {
    ...
    public boolean isDrill() {
        return getStackInSlot(1) != null && getStackInSlot(2) != null
            && getStackInSlot(1).getItem() instanceof DrillHead
            && getStackInSlot(2).getItem() instanceof DrillBody;
    }

    public boolean isSword() {
        return getStackInSlot(1) != null && getStackInSlot(2) != null
            && getStackInSlot(1).getItem() instanceof SwordBlade
            && getStackInSlot(2).getItem() instanceof SwordHandle
            && getStackInSlot(3) != null
            && checkCapacitor(3);
    }

    public boolean checkForDisassembleSword() {
        return getStackInSlot(0) != null && getStackInSlot(1) == null
            && getStackInSlot(2) == null
            && getStackInSlot(3) == null
            && getStackInSlot(4) == null
            && getStackInSlot(5) == null
            && getStackInSlot(6) == null
            && getStackInSlot(0).getItem() instanceof RedstonicSword;
    }
    ...
    public void assembleSword() {
        ...
        if (getStackInSlot(1).stackTagCompound != null)
            nbt.setInteger("totalKills", getStackInSlot(1).stackTagCompound.getInteger("totalKills"));
        ...
        if (rename != "")
            getStackInSlot(0).setStackDisplayName("" + EnumChatFormatting.RESET + EnumChatFormatting.GOLD + rename);
    ...
    public void assembleDrill() {
        ...
        if (rename != "")
            getStackInSlot(0).setStackDisplayName("" + EnumChatFormatting.RESET + EnumChatFormatting.RED + rename);
    ...
    public void disassembleSword() {
        ...
        if (getStackInSlot(3).getItem() instanceof ItemBattery
            && getStackInSlot(3).getItem() != RedstonicItems.infiniteBattery) {
            double modifier = (double) 80 / getStackInSlot(3).stackTagCompound.getInteger("maxEnergy");
            getStackInSlot(3)
                .setItemDamage((int) (80 - getStackInSlot(3).stackTagCompound.getInteger("Energy") * modifier));
        }
        dissName = !getStackInSlot(0).getDisplayName()
            .equals("§6Redstonic Sword") ? getStackInSlot(0).getDisplayName()
                .replace("§6", "") : "";
    ...
    public void disassembleDrill() {
        ...
        setInventorySlotContents(3, DrillUtil.getDrillBattery(battery, getStackInSlot(0)));
        if (getStackInSlot(3) != null && getStackInSlot(3).getItem() instanceof ItemBattery
            && getStackInSlot(3).getItem() != RedstonicItems.infiniteBattery) {
            double modifier = (double) 80 / getStackInSlot(3).stackTagCompound.getInteger("maxEnergy");
            getStackInSlot(3)
                .setItemDamage((int) (80 - getStackInSlot(3).stackTagCompound.getInteger("Energy") * modifier));
        ...
        dissName = !getStackInSlot(0).getDisplayName()
            .equals("§cRedstonic Drill") ? getStackInSlot(0).getDisplayName()
                .replace("§c", "") : "";
    ...
    public boolean checkPartsDrill() {
        return getStackInSlot(1).getItem() instanceof DrillHead && getStackInSlot(2).getItem() instanceof DrillBody
            && checkCapacitor(3);
    }
    ...
    public boolean checkCapacitor(int i) {
        if (Loader.isModLoaded("ThermalExpansion")) {
            ...
            return getStackInSlot(i).isItemEqual(hardened) || getStackInSlot(i).isItemEqual(reinforced)
                || getStackInSlot(i).isItemEqual(resonant)
                || getStackInSlot(i).isItemEqual(creative)
                || getStackInSlot(i).getItem() instanceof ItemBattery;
        } else {
    ...
    public boolean checkForDisassemble() {
        return getStackInSlot(0) != null && getStackInSlot(0).getItem() instanceof RedstonicDrill
