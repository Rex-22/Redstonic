...
public class RenderDriller extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation drillerTexture = new ResourceLocation(
        "redstonic:textures/model/Driller/Driller.png");
    private static final ResourceLocation iron = new ResourceLocation(
        "redstonic:textures/model/Driller/Heads/Iron.png");
            ...
            if (header != 999) {
                this.bindTexture(
                    new ResourceLocation(
                        "redstonic:textures/model/Driller/Heads/" + DrillUtil.getDrillHeadName(header) + ".png"));
